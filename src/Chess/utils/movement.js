...
const kingMoves = (from, color, allPieces) => {
    let [x, y] = from
    const moves = []
    let pX = [-1, 0, 1]
    let pY = [-1, 0, 1]
...
const pawnMoves = (from, color, allPieces, lastmove) => {
    let [x, y] = from
    const moves = []
...
export const getMoves = (piece, allPieces, lastmove) => {
    let moves = []
    switch (piece.type) {
        case 'rook':
        ...
        case 'queen':
            ...
            break
        case 'king':
            moves = [...kingMoves(piece.position, piece.color, allPieces)]
            break
        case 'pawn':
            moves = [...pawnMoves(piece.position, piece.color, allPieces, lastmove)]
            break
        case 'knight':
...
export const move = (piece, color,  from, to, allPieces, lastmove) => {
    if(piece === 'pawn'){
        return pawnMove(color, from, to, allPieces, lastmove);
    }
    else if(piece === 'king'){
        return kingMove(color, from, to, allPieces);
    }
    else if(piece === 'queen'){
        return queenMove(color, from, to, allPieces);
    }
    else if(piece === 'rook'){
        return rookMove(color, from, to, allPieces);
    }
    else if(piece === 'bishop'){
        return bishopMove(color, from, to, allPieces);
    }
    else if(piece === 'knight'){
        return knightMove(color, from, to, allPieces);
    }
    return false;
}